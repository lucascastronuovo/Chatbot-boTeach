...
A diferencia de los chatbots tradicionales, boTeach **no entrega respuestas directas**. Su enfoque pedagógico está inspirado en el rol de un docente: **enseñar a pensar**, guiando al estudiante mediante pistas, fomentando la reflexión y evaluando su comprensión real del contenido.
